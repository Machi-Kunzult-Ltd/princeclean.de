...
export default function TeppichPage() {
  ...
  const additionalServices = [
    ...
    },
    {
      ...
      price: '9,00€/m²',
      note: '',
      description: 'für einen Schutz vor oder auch zur Bekämpfung von Mottenbefall',
    },
    {
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="p-4 sm:p-6 md:p-8">
              ...
              <div className="space-y-6 sm:space-y-8">
                {standardCleaning.map((category, index) => (
                  <div key={index} className="border-l-4 border-[#3b82f6] pl-4 sm:pl-6">
                    ...
                    <ul className="space-y-1 sm:space-y-2 ml-4">
                      {category.items.map((item, itemIndex) => (
                        <li key={itemIndex} className="text-sm sm:text-base text-gray-600 flex items-start">
              ...
              <div className="mt-6 sm:mt-8 p-3 sm:p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg">
                <p className="text-xs sm:text-sm text-gray-700 font-medium">
                  Bitte beachten Sie, dass die Preise für Übergrößen oder sehr schwere
                  Teppiche abweichen können.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border-l-4 border-[#3b82f6] p-4 sm:p-6 rounded-r-lg mb-8 sm:mb-12">
            <p className="text-gray-700 text-sm sm:text-base">
              Sofern Sie noch weitere Wünsche oder Fragen haben, sprechen Sie uns
              einfach an. <strong>Wir sind für Sie da!</strong>
            </p>
          </div>
